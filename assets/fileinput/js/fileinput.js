...
(function (factory) {
    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFileIcon = '<i class="far fa-file"></i>';
            ...
            self.defaults = {
                ...
                fileActionSettings: {
                    ...
                    indicatorSuccess: '<i class="far fa-check-circle text-success"></i>',
                    indicatorError: '<i class="fas fa-exclamation text-danger"></i>',
                    indicatorLoading: '<i class="far fa-hourglass text-muted"></i>',
    ...
    $.fn.fileinput.defaults = {
        ...
        customLayoutTags: {},
        customPreviewTags: {},
        previewFileIcon: '<i class="far fa-file"></i>',
